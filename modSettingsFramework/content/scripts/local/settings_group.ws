abstract class ISettingsGroup
{
    ...
    public function ReadSettings(optional config: CInGameConfigWrapper) : void 
    {
        if (!config)
    ...
    public function WriteSettings(shouldSave: bool, optional config: CInGameConfigWrapper) : void 
    {
        if (!config)
			config = theGame.GetInGameConfigWrapper();
    ...
    // Applies a preset
    public function ResetSettings(presetIndex: int, shouldSave: bool, optional config: CInGameConfigWrapper) : void
    {
        if (!config)
			config = theGame.GetInGameConfigWrapper();
        ...
        ReadSettings(config); // get preset values back from config
    ...
    public function ResetSettingsToDefault(shouldSave: bool, optional config: CInGameConfigWrapper) : void
    {
        ResetSettings(defaultPresetIndex, shouldSave, config);
    }
