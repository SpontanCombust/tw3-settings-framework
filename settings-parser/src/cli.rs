...
pub struct CLI {
    ...
    #[clap(long, short = 'p', display_order=2)]
    ...
    #[clap(long, arg_enum, default_value="enums", verbatim_doc_comment, display_order=4)]
